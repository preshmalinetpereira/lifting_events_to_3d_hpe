...
def extract_from_aedat(aedat, events, startTime, stopTime, sx, sy, nbcam, thrEventHotPixel, dt, xmin_mask1, xmax_mask1, ymin_mask1, ymax_mask1, xmin_mask2, xmax_mask2, ymin_mask2, ymax_mask2):
    ...
    X_tmp1, y_tmp1, timeStamp_tmp1, pol_tmp1, cam_tmp1 = BackgroundFilter(X_tmp, y_tmp, timeStamp_tmp, pol_tmp, cam_tmp, sx*nbcam, sy, dt)
    
    X_tmp2, y_tmp2, timeStamp_tmp2, pol_tmp2, cam_tmp2 = maskRegionFilter(X_tmp1, y_tmp1, timeStamp_tmp1, pol_tmp1, cam_tmp1, xmin_mask1, xmax_mask1, ymin_mask1, ymax_mask1)
    
    X_tmp3, y_tmp3, timeStamp_tmp3, pol_tmp3, cam_tmp3 = maskRegionFilter(X_tmp2, y_tmp2, timeStamp_tmp2, pol_tmp2, cam_tmp2, xmin_mask2, xmax_mask2, ymin_mask2, ymax_mask2)
